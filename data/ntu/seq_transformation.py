...
if __name__ == '__main__':
    ...
    for evaluation in evaluations:
        ...
        print('  Saved NTU60_%s.npz' % evaluation)

    print('[6/6] Creating aligned dataset (skeleton alignment)... This may take 10+ minutes.')
    create_aligned_dataset(file_list=['NTU60_CS.npz', 'NTU60_CV.npz'])
    print('All done! Files generated in current directory.')