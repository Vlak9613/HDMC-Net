"""
HDMC-Net Graph Utilities

Graph construction and manipulation functions for skeleton topology.
"""
...
def get_sgp_mat(num_in, num_out, link):
    """Get spatial graph partition matrix."""
...
def get_spatial_graph(num_node, self_link, inward, outward):
    """Get spatial graph with self-loop, inward and outward connections."""
...
def normalize_adjacency_matrix(A):
    """Symmetric normalization of adjacency matrix: D^(-0.5) @ A @ D^(-0.5)."""
...
def get_multiscale_spatial_graph(num_node, self_link, inward, outward):
    """Get multi-scale spatial graph (1-hop and 2-hop)."""
    I = edge2mat(self_link, num_node)
